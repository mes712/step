...
public final class FindMeetingQueryTest {
  ...
  public void everyAttendeeIsConsideredExceptOptional() {
    // Have each person have different events. We should see two options because each person has
    // split the restricted times. Optional person is ignored
    //
    // Events  :       |--A--|     |--B--|
    // Optional: |-------------C---------------|
    // Day     : |-----------------------------|
    ...
    Collection<Event> events = ImmutableList.of(
        ...
        new Event("Event 2", TimeRange.fromStartDuration(TIME_0900AM, DURATION_30_MINUTES),
            ImmutableList.of(PERSON_B)),
        new Event("Event 3", TimeRange.WHOLE_DAY, ImmutableList.of(PERSON_C)));
  ...
  @Test
  public void optionalAttendeesWithTime() {
    // Two optional attendees, space in schedules
    // Events  :       |--A--|     |--B--|
    // Day     : |-----------------------------|
    // Options : |--1--|     |--2--|     |--3--|
    Collection<Event> events = ImmutableList.of(
    ...
    MeetingRequest request =
        new MeetingRequest(ImmutableList.of(), DURATION_30_MINUTES);
  ...
  @Test
  public void optionalAttendeesNoTime() {
    // Two optional attendees with no room
    //
    // Events  : |-----A-----||-------B--------|
    // Day     : |-----------------------------|
    // Options : 
